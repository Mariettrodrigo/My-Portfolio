...
const Services = ({isDarkMode}) => {
  return (
    ...
    id='services' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>I am an undergraduate in Computing and Information Systems with interests in project management and business analysis.</motion.p>
