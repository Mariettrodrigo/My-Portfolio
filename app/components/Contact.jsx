...
const Contact = () => {
  ...
  return (
    <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto]'>
      ...
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-ovo'>I'd love to hear from ypu! If you have an questions, comments, or feedback, please use the form below.</p>
